    ...
    <td id="mid" height="350px" background="images/home_img.jpg" valign="top">
      ...
      <tr>
        ...
        <table width="260px" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td style="background:url(images/login_head.jpg) no-repeat; height:30px; width:1000px; color:#FFFFFF; font-size:16px; font-weight:bold; text-align:center"><div align="center">Signup</div></td>
          </tr>
          <tr>
            <td height="135" style="border:solid #990000 1px;"><div align="center">
            <form action="./signup_db.php" method="post" name="frm">
              <table width="300" height="143" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="31" colspan="2"><div align="center"><?php=$_GET['msg']; ?></div></td>
                  </tr>
                <tr>
                  <td width="84" height="25"><div align="right" class="style3">NickName :&nbsp;</div></td>
                  <td width="174" align="left">
                      <input type="text" name="nname" />                  </td>
                </tr>
                <tr>
                  <td height="25"><div align="right" class="style3">First Name :&nbsp;</div></td>
                  <td align="left"><input type="text" name="fname" /></td>
                </tr>
				<tr>
                  <td height="25"><div align="right" class="style3">Last Name :&nbsp;</div></td>
                  <td align="left"><input type="text" name="lname" /></td>
                </tr>
				<tr>
                  <td height="25"><div align="right" class="style3">Class :&nbsp;</div></td>
                  <td align="left"><input type="text" name="sem" /></td>
                </tr>
				<tr>
                  <td height="25"><div align="right" class="style3">Username :&nbsp;</div></td>
                  <td align="left"><input type="text" name="username" /></td>
                </tr>
				<tr>
                  <td height="25" width="500"><div align="right" class="style3">Email/Phone :&nbsp;</div></td>
                ...
                <tr>
                  <td colspan="2" height="25">
                      <div align="center">
                        <input type="submit" name="button" id="but_sub" value="SIGNUP" style="margin:5px;" />
                      </div></td>
                  </tr>
              </table>
              </form>
