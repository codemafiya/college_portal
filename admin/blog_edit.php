        ...
        <table width="900" height="277" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="309"><div align="left">
                <label>
                <input name="subject" type="text" size="50" value="<?php echo $row['blogsubject']; ?>" />
                </label>
            </div></td>
	            <td width="195">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td><div align="left">
                <textarea name="blog_text" cols="35" rows="4" id="textfield3"><?php echo $row['blogtext']; ?></textarea>
            </div></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
