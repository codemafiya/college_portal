    ...
    <table width="900" height="277" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="223"><div align="left">
            <label>
              <input name="surname" type="text" size="35" value="<?php echo $row['studsurname']; ?>" />
              </label>
      ...
      <tr>
        ...
        <td><div align="left">
          <label>
          <input name="firstname" type="text" id="textfield2" size="35" value="<?php echo $row['studfirstname']; ?>" />
          </label>
        </div></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        ...
        <td><div align="left">
          <label>
          <input name="lastname" type="text" id="textfield3" size="35" value="<?php echo $row['studlastname']; ?>" />
          </label>
        </div></td>
        <td>&nbsp;</td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <div align="left">
            <input name="loginid" type="text" id="textfield4" size="35" value="<?php echo $row['studloginid']; ?>" />
            </div>
        </td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        ...
        <td><div align="left">
          <label>
          <input name="password" type="password" id="textfield5" size="35" value="<?php echo $row['studpassword']; ?>" onblur="chk_fld()" />
          </label>
        </div></td>
        <td>&nbsp;</td>
      </tr>
