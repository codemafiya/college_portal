      ...
      <table width="900" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><form action="./assignment_edit_db.php" method="post" name="form1" id="form1" onsubmit="return ValidateForm()">
            ...
            <input type="hidden" name="id" value="<?php echo $row['assignid']; ?>" />
            <table width="900" height="312" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="309"><div align="left">
                    <label>
                    <input name="title" type="text" size="35" value="<?php echo $row['assigntitle']; ?>" />
                    </label>
                </div></td>
                <td width="195">&nbsp;</td>
              </tr>
              <tr>
                ...
                <td><div align="left">
<input type="text" name="txtDate" maxlength="10" size="15" value="<?php echo $row['assigndate']; ?>"  />                  
(dd/mm/yyyy)</div></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                ...
                <td><div align="left">
                    <label>
                    <textarea name="assign_text" cols="35" rows="4" id="textfield3"><?php echo $row['assigntext']; ?></textarea>
                    </label>
                </div></td>
                <td>&nbsp;</td>
              </tr>
