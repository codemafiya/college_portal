      ...
      <tr>
        <td><div align="center">
          <form action="./queries_edit_db.php" method="post" name="form1" id="form1" onsubmit="return ValidateForm()">
            ...
            <input type="hidden" name="id" value="<?php echo $row['queryid']; ?>" />            
            <table width="900" height="312" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="309"><div align="left">
                    <label>
                    <input name="subject" type="text" size="35" value="<?php echo $row['querysubject']; ?>" />
                    </label>
                </div></td>
                <td width="195">&nbsp;</td>
              </tr>
              <tr>
                ...
                <td><div align="left">
                    <input type="text" name="txtDate" maxlength="10" size="15" value="<?php echo $row['querydate']; ?>" />
                  (dd/mm/yyyy)</div></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                ...
                <td><div align="left">
                    <label>
                    <textarea name="query_text" cols="35" rows="4" id="textfield3"><?php echo $row['querytext']; ?></textarea>
                    </label>
                </div></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                ...
                <td><div align="left">
                    ...
                    <select name="faculty" style="width:200px;">
                      <?php
						$result=mysqli_query("select * from staff order by staffsurname");
