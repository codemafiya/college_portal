...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="main">
  ...
  <tr>
    <td id="mid" valign="top"><table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="3"><div align="center" style="margin:5px;"><strong><?php echo $_GET['msg']; ?></strong></div></td>
      </tr>
      <tr>
            ...
            <tr>
              <td colspan="3" width="899px" id="box_border" valign="top" align="center">
                ...
                <?php
					...
					$result=mysqli_query($con,"select * from query where studid='".get_studid($_SESSION['cuser'])."' order by querydate desc");
      ...
      <tr>
        ...
        <input type="hidden" name="login" value="<?php echo $_SESSION['cuser']; ?>">      
          ...
          <tr>
            ...
            <td><div align="left">
                ...
                <?php
                        ...
                        while($row=mysqli_fetch_array($result))
                        {
                  			echo "<option>".$row['staffsurname']."</option>";      
                        }
				?>
                </select>
                </label>
