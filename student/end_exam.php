<?php
	...
	$result=mysqli_query($con,"select * from questionbank where quesubject='$id'");
		...
		$per=($t*100)/$tq;
		$user=$_SESSION['cuser'];
		$r=mysqli_query($con,"insert into examresult (studid,examdate,examtime,examsubject,examquetotal,examquetrue,examquefalse) values('$user','$date','$time','$id','$tq','$t','$f')");
?>
    ...
    <td id="mid" valign="top"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="790" id="head_txt"><div align="left">
            <div align="left" class="style5"><?php echo $id; ?> Exam Result</div>
        </div></td>
                  ...
                  <tr>
                    <td><div align="center">
                      <table width="651" height="134" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td colspan="3"><div align="center"><strong>Wrong Answers : <?php echo $f; ?>
                          </strong></div></td>
                        </tr>
                        <tr>
                          ...
                          <table width="195" height="18" border="0" style="border:solid 1px #990000" cellpadding="0" cellspacing="1">
                            <tr>
                              <td><table width="<?php echo $per; ?>%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
