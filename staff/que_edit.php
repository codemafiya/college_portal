        ...
        <input type="hidden" value="<?php echo $id; ?>" name="id" />
	      <table width="900" height="353" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td><div align="left">
                  <textarea name="que_text" cols="35" rows="2"><?php echo $row['quetext']; ?></textarea>
              </div></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              ...
              <td><div align="left">
                  <input name="ans1" type="text" id="textfield" size="40" value="<?php echo $row['queans1']; ?>" />
              </div></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              ...
              <td><div align="left">
                  <input name="ans2" type="text" id="textfield2" size="40"  value="<?php echo $row['queans2']; ?>"/>
              </div></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              ...
              <td><div align="left">
                  <input name="ans3" type="text" id="textfield4" size="40" value="<?php echo $row['queans3']; ?>" />
              </div></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              ...
              <td><div align="left">
                  <input name="ans4" type="text" id="textfield5" size="40" value="<?php echo $row['queans4']; ?>" />
              </div></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
