          ...
          <td id="profile_mid" valign="top">
            <table width="100%" height="527" border="0" cellpadding="0" cellspacing="0" style="margin:5px;">
              <tr>
                ...
                <td width="14%"><img src="../img/<?php echo $row['staffimg']; ?>" alt="Profile" width="128" height="128" /></td>
              ...
              <tr>
                ...
                <form action="profile_edit_db.php" method="post" enctype="multipart/form-data" name="frm">
                  <input name="id" type="hidden" value="<?php echo $row['staffid']; ?>" />                
                  <table width="100%" height="338" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td colspan="2"><div align="left"><span id="sprytextfield2">
                        <input name="sname" type="text" value="<?php echo $row['staffsurname']; ?>" size="35" />
                    ...
                    <tr>
                      ...
                      <td colspan="2"><div align="left"><span id="sprytextfield3">
                        <input name="fname" type="text" value="<?php echo $row['stafffirstname']; ?>" size="35" />
                        <span class="textfieldRequiredMsg">A value is required.</span></span></div></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      ...
                      <td colspan="2"><div align="left"><span id="sprytextfield4">
                        <input name="lname" type="text" value="<?php echo $row['stafflastname']; ?>" size="35" />
                        <span class="textfieldRequiredMsg">A value is required.</span></span></div></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <input name="email" type="text" value="<?php echo $row['staffemail']; ?>" size="35" />
                    ...
                    <tr>
                      ...
                      <td colspan="2"><div align="left">
                        <textarea name="hobbies" cols="35" rows="3">  <?php echo $row['staffhobby']; ?>
                        </textarea>
                      </div></td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="2"><div align="left"><span id="sprytextarea1">
                        <textarea name="qualification" cols="35" rows="3">  <?php echo $row['staffqualification']; ?>
                        </textarea>
                    ...
                    <tr>
                      ...
                      <td colspan="2"><div align="left"><span id="sprytextarea2">
                        <textarea name="certification" id="textarea" cols="35" rows="3"><?php echo $row['staffcertification']; ?>
                        </textarea>
                                <span class="textareaRequiredMsg">A value is required.</span></span></div></td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="2"><div align="left"><span id="sprytextarea3">
                        <textarea name="experience" id="textarea2" cols="35" rows="3"><?php echo $row['staffexperience']; ?>
                        </textarea>
                        <span class="textareaRequiredMsg">A value is required.</span></span></div></td>
                    </tr>
                    <tr>
                      ...
                      <td width="445"><div align="left">(Size: 128x128px )
                     	<input type="hidden" name="img" value="<?php echo $row['staffimg']; ?>" />
                      </div></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
