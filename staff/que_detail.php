        ...
        <td><div align="center">
          <table width="902" border="0" cellspacing="0" cellpadding="0" style="margin:10px;">
            ...
            <tr>
              ...
              <td width="488"><div align="left"><?php echo $row['quesubject']; ?></div></td>
              <td width="37">&nbsp;</td>
            </tr>
            <tr>
              <td><div align="right" class="style2">Question Text :&nbsp; </div></td>
              <td><div align="left">
                  <?php echo $row['quetext']; ?>
              </div></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><div align="left">
                  <?php echo $row['queans4']; ?>
              </div></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td><div align="right"><strong>Answer :&nbsp; </strong></div></td>
              <td><div align="left"><?php echo $row['queansfinal']; ?></div></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
